...
-export_type(['msg'/0, 's_role'/0, 'register_tos'/0, 'register_toc'/0, 'login_tos'/0, 'login_toc'/0]).

-spec encode_msg(#msg{} | #s_role{} | #register_tos{} | #register_toc{} | #login_tos{} | #login_toc{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#msg{} | #s_role{} | #register_tos{} | #register_toc{} | #login_tos{} | #login_toc{}, atom() | list()) -> binary().
...
get_msg_names() ->
    [msg, s_role, register_tos, register_toc, login_tos,
     login_toc].
